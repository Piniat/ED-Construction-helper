from . import exit_app, edit_delivery_progress, edit_shopping_list, state, ship_cargo_ask, error_logger
...
def user_input():
    try:
        command_list = WordCompleter(["help", "delivery-tracker", "shopping-list", "journal-monitor","edit-shopping-list", "edit-delivery-progress", "edit-ship-cargo", "exit", "reset-progress"], ignore_case=True)
        while True:
            with patch_stdout():
